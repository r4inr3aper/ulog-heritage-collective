            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-6">
                <p className="text-lg text-gray-700 leading-relaxed">
                  Founded with passion and purpose, জিঞাঁ is a heartfelt attempt to reconnect the world with Assam's rich cultural fabric. 
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Every product in our collection tells a story of heritage, skill, and hope. Through জিঞাঁ, we're not just preserving 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 italic max-w-4xl mx-auto leading-relaxed">
              ...
              At জিঞাঁ, we don't just sell products – we nurture potential."
            </p>
          </div>
          ...
          <Card className="border-0 shadow-2xl bg-white/80 backdrop-blur-sm">
            <CardContent className="p-12 lg:p-16 text-center">
              ...
              <div className="space-y-8">
                ...
                <blockquote className="text-xl text-gray-700 leading-relaxed italic">
                  "জিঞাঁ is a tribute to her and to thousands like her – women who carry culture in their hands and hearts. 
              ...
              <div className="flex justify-center items-center space-x-4 mt-10">
                ...
                <div className="text-left">
                  ...
                  <p className="text-gray-600">জিঞাঁ Heritage Collective</p>
                </div>
              </div>
            </CardContent>
          </Card>
